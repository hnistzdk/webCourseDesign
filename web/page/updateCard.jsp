            ...
            <form class="form-horizontal m-t-20" method="post" id="updateCardForm" onsubmit="return false">
                ...
                <div class="form-group">
                    <div class="col-xs-12">
                        ...
                        <input class="input-lg input-border" name="number" value="${card.number}" type="text" required="" placeholder="卡号"/>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-xs-12">
                        <label class="col-sm-2 col-form-label">余额</label>
                        <input class="input-lg input-border" name="number" value="${card.balance}" type="text" required="" placeholder="余额"/>
                    </div>
                </div>
            </form>
            <div class="form-group text-center">
                <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
                <button type="button" onclick="updateCard()" class="btn btn-primary">保存</button>
            </div>
        </main>
    </div>
</div>
